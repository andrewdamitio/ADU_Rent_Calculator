      ...
      {view==="internal"&&(<>
        ...
        <div style={{...card,padding:"18px 22px 14px",marginBottom:12}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:6}}>
            ...
            <div style={{fontSize:10.5,color:"#8b949e",lineHeight:1.55,marginTop:1,marginBottom:2}}>Includes plan review and all construction inspections (foundation, framing, rough MEP, insulation, final/CO). Re-inspection fees if something fails are typically $100–$500 and come out of the builder's margin.</div>
            ...
            <div style={{fontSize:10.5,color:"#8b949e",lineHeight:1.55,marginTop:1,marginBottom:2}}>{hasSTR?"Furniture, linens, kitchenware, decor — everything a guest needs. Built-in kitchen appliances (fridge, range, dishwasher) are already in structure $/sqft.":"Washer/dryer, furniture, or other extras beyond what the builder installs. Built-in kitchen appliances (fridge, range, dishwasher) are already in structure $/sqft. Set to $0 if tenant-supplied."}</div>
            <TS label="Contingency" value={contingency} onChange={set("contingency")} min={0} max={20} step={1} format={v=>v===0?"None":v+"% ("+fD(contingencyAmt)+")"} ticks={[{value:0,label:"None",color:gn},{value:5,label:"Typical",color:tb},{value:10,label:"Complex",color:tk},{value:15,label:"High risk",color:yl}]}/>
            <div style={{fontSize:10.5,color:"#8b949e",lineHeight:1.55,marginTop:1,marginBottom:2}}>Percentage of hard costs (structure + site work) set aside for unforeseen items — buried utilities, soil surprises, permit re-inspections, landscaping restoration. 5% is standard for straightforward builds; 10–15% for complex sites or older neighborhoods with unknown infrastructure.</div>
        ...
        <div style={{...card,padding:"18px 22px 14px",marginBottom:12}}>
          ...
          {hasSTR&&(
            <div style={{display:"flex",flexDirection:"column",gap:6,marginTop:12,paddingTop:10,borderTop:"1px solid #21262d"}}>
              ...
              <div style={{fontSize:10.5,color:"#8b949e",lineHeight:1.55,marginTop:1,marginBottom:2}}>Annual growth in the STR average daily rate. Post-pandemic normalization has settled ADR growth at 1.5–2.5%/yr for most markets; above 3.5% is strong. {isHybrid?"LTR months use the separate rent growth slider under Income & Tax Assumptions.":""} Property value is always projected using LTR rent growth.</div>
              ...
              <div style={{fontSize:10.5,color:"#8b949e",lineHeight:1.55,marginTop:1,marginBottom:2}}>Platform fees + cleaning + management for STR {isHybrid?"months only. LTR months use the management rate in Operating Expenses below.":"year-round. Replaces property management in Operating Expenses."}</div>
              ...
              <div style={{fontSize:10.5,color:"#8b949e",lineHeight:1.55,marginTop:1,marginBottom:2}}>{isHybrid?"Unbooked nights during STR months. LTR months use the vacancy rate in Operating Expenses below.":"Percentage of nights unbooked year-round. LTR vacancy is much lower at 3–8%."}</div>
        ...
        <div style={{...card,padding:"18px 22px 14px",marginBottom:12}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:8}}>
            ...
            <div style={{borderTop:"1px solid #21262d",marginTop:10,paddingTop:8}}>
              ...
              <div style={{fontSize:10.5,color:"#8b949e",lineHeight:1.55,marginTop:2}}>Months from permit approval to first rent check. Loan payments don't start until construction is complete — this is dead time with no income and no payments, like solar. Shifts CF+ and Payback forward by {buildMonths} months.</div>
            </div>
          </div>
        </div>
