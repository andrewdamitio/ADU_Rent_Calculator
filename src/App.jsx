      ...
      {view==="internal"&&(<>
        ...
        <div style={{...card,padding:"18px 22px 14px",marginBottom:12}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:6}}>
            ...
            <div style={{fontSize:10,color:"#6e7681",lineHeight:1.4,marginTop:1,marginBottom:2,fontStyle:"italic"}}>Percentage of hard costs (structure + site work) set aside for unforeseen items — buried utilities, soil surprises, permit re-inspections, landscaping restoration. 5% is standard for straightforward builds; 10–15% for complex sites or older neighborhoods with unknown infrastructure.</div>
